...
export default function Dashboard() {
  ...
  const badge = (status) => {
    ...
    switch (status) {
      case "Preparing":
        return `${base} bg-yellow-500/20 text-yellow-300 border-yellow-400`;
      case "Be Ready":
        return `${base} bg-blue-500/20 text-blue-300 border-blue-400`;
      case "Take From Counter":
        return `${base} bg-purple-500/20 text-purple-300 border-purple-400`;
      case "Completed":
        return `${base} bg-green-500/20 text-green-300 border-green-400`;
      default:
        return `${base} bg-gray-500/20 text-gray-300 border-gray-400`;
    }
  };

  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-black via-gray-900 to-black text-white p-6">
      ...
      <div className="relative z-10">
        ...
        <div className={`${glass} p-6 text-center`}>
          ...
          <p className="text-gray-400 mt-1">
            Live Orders • Real-time Control • Premium Dashboard
          </p>
        </div>
